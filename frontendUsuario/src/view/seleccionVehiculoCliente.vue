<template>
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav w-100 d-flex justify-content-between">
        ...
        <li class="nav-item flex-fill text-center">
          <a class="nav-link active fw-bold custom-link" aria-current="page" aria-disabled="true">Confirmar reserva</a>
        </li>
        <li class="nav-item flex-fill text-center">
          <a class="nav-link disabled fw-bold" href="#" tabindex="-1" aria-disabled="true">Pagar</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="data-container" v-if="vehiculo">
    <div class="data-section">
      ...
      <p><strong>Total:</strong> (vehículo)</p>
